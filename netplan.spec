...
Version  : 1.0.1
Release  : 11
URL      : https://github.com/canonical/netplan/archive/1.0.1/netplan-1.0.1.tar.gz
Source0  : https://github.com/canonical/netplan/archive/1.0.1/netplan-1.0.1.tar.gz
...
%prep
%setup -q -n netplan-1.0.1
cd %{_builddir}/netplan-1.0.1
%patch -P 1 -p1
%patch -P 2 -p1
pushd ..
cp -a netplan-1.0.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720135784
